 ...
 */
tio.ws = function (obj) {
  var ws_protocol=obj.ws_protocol, ip=obj.ip, port=obj.port, paramStr=obj.queryString, param=obj.param, handler=obj.handler, heartbeatTimeout=obj.heartbeatTimeout, reconnInterval=obj.reconnInterval, binaryType=obj.binaryType;
  this.ip = obj.ip
  this.port = obj.port
  this.url = obj.ws_protocol + '://' + obj.ip + ':' + obj.port
